...
---
![MKD - Самостоятельно размещаемый Markdown-редактор](../../docs/screens/main_interface.png "Главный экран редактора")
...
- **Экспорт** в форматы `.txt`, `.md`, `.pdf`, `.html`, `.docx` и `.zip` с локально связанными изображениями;
  - Чтобы точно понять, как элементы отображаются в форматах `.docx` и `.pdf`, экспортируйте файл `markdown-cheat-sheet.md`, входящий в стандартный *workspace*.
- **Автосохранение**
- **Вкладки** — редактирование нескольких документов одновременно
- **Интерфейс и проверка орфографии на нескольких языках** — Португальский, Английский, Испанский, Французский, Немецкий, Русский, Хинди и Упрощённый Китайский
